...
public class Qcomments extends Connect
{
	...
	{
		String SQL = "INSERT INTO `qcomments` (`qcomment_question_id`, `qcomment_name`, `qcomment_email`, `qcomment_description`) VALUES (?, ?, ?, ?);";
		int record=0; 
		String error = "";
		...
		try
		{
			...
			pstmt.setString(1,(String) ticketData.get("qcomment_question_id"));
    ...
    public ArrayList getAllQcomments(String question_id)
	{
		String SQL = "SELECT * FROM `qcomments` WHERE qcomment_question_id = "+question_id+" ORDER BY qcomment_id ASC";
		int count=0;
